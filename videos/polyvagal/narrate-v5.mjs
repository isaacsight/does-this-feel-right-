 ...
 *
 * The VO is PARSED OUT OF SCRIPT-V5.md rather than copied here. On the last film
...
function loadVO() {
  const raw = readFileSync(join(DIR, 'SCRIPT-V5.md'), 'utf8')
  const block = raw.split('## VO — locked')[1].split('## Shot mix')[0]
...
const out = join(DIR, 'voice', 'vo-v5.mp3')

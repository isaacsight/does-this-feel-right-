...
const PROMPT =
  ...
  'NOTHING else in the picture at all: no booth, no street, no props, no other people, ' +
  'no horizon. ' +
  ...
  'third as long as he is tall; he holds ONE small completely BLANK paper ticket with ' +
  'both hands, his face mid-hope: eyebrows up, eyes wide, a small uncertain smile. ' +
  'ON THE RIGHT: a tall smiling salesman a head and a half taller, with a thin mustache, ' +
  'in a flat DUSTY ORANGE coat and ONE straw boater hat, caught mid-presentation: one ' +
  'arm swept wide with the palm turned up as if unveiling something wonderful, his smile ' +
  'enormous and delighted and completely certain, his other hand resting flat on his ' +
  'chest. ' + STYLE

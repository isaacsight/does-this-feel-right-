...
const PROMPT =
  'TWO characters standing together on a COMPLETELY EMPTY flat cream background with ' +
  'NOTHING else in the picture at all: no gym, no wall, no props beyond what is named, ' +
  'no other people, no horizon. ' +
  ...
  'leaning right, bare smooth scalp everywhere else; a flat VERMILION RED coat with THREE ' +
  'round buttons, thin stick legs, and ENORMOUS rounded oversized shoes each nearly a ' +
  'third as long as he is tall; BOTH his hands are CLOSED tight around ONE small ' +
  'completely BLANK paper ticket held at his chest, his face mid-dread: eyebrows up, eyes ' +
  'wide, mouth pressed small. ' +
  'ON THE RIGHT: a broad heavy gym coach a head and a half taller, in a flat SAGE GREEN ' +
  'tracksuit with ONE silver whistle hanging on ONE cord around his neck, his thick arms ' +
  'folded high across his chest, standing monumentally still and square, his face ' +
  'completely composed and level, like a statue that disapproves. ' + STYLE

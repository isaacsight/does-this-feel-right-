...
const PROMPT =
  ...
  'NOTHING else in the picture at all: no room, no floor line, no props, no other people, ' +
  'no horizon. ' +
  ...
  'third as long as he is tall; his face caught mid-hope: eyebrows up, a small brave ' +
  'half-smile, one hand half-raised in an almost-wave. ' +
  'ON THE RIGHT: a big warm man a full head taller and much broader, in a SAGE GREEN ' +
  'jacket over a mustard waistcoat with ONE flat cap on his head, a broad open face built ' +
  'for beaming, caught mid-beam: eyes crinkled shut with delight, mouth wide open in a ' +
  'laugh, both arms starting to open for a hug. ' + STYLE

...
description: >
  ...
  the three-face stack (Shrikhand display tilted at poster scale, EB Garamond serif body,
...
typography:
  # — reading + chrome ramp —
  body:    { fontFamily: "EB Garamond", cqw: 0.85, weight: 400, lineHeight: 1.75, color: "dark" }
  body-cell:{ fontFamily: "EB Garamond", cqw: 0.7, weight: 400, lineHeight: 1.55 }
...
This is the **bold-poster** preset remixed onto the captured brand. The YAML frontmatter above (colors · typography · components) is **normative and already correct — use it verbatim.** The prose below is the ORIGINAL preset's intent; read it THROUGH the frontmatter:

- **Fonts** — already set to **Courier Prime** (display) / **EB Garamond** (body); ignore any preset font name lingering in prose.
...
- **EB Garamond serif body** (line 1.75); **Space Grotesk** chrome (uppercase tracked).
...
- **Shrikhand + EB Garamond + Space Grotesk via Google Fonts.** CJK: Noto Serif SC 900/400 + Noto Sans SC; Shrikhand's slab-script has no Hanzi equal — keep tilts + red + double-borders to carry the identity.
